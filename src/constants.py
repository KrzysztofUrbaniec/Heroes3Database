...
TABLE_CREATION_QUERIES['units_table'] = (
...
TABLE_CREATION_QUERIES['heroes_table'] = (
"CREATE TABLE IF NOT EXISTS `heroes` ("
" `hero_name` VARCHAR(20), `class` VARCHAR(20), `specialty` VARCHAR(20), `skill1` VARCHAR(20), `skill2` VARCHAR(20), `spell` VARCHAR(20)"
")")

TABLE_CREATION_QUERIES['artifacts_table'] = (
"CREATE TABLE IF NOT EXISTS `artifacts` ("
" `artifact_name` VARCHAR(100), `slot` VARCHAR(20), `class` VARCHAR(20), `cost` INT, `effect` VARCHAR(200), `spell` VARCHAR(150)"
")")
